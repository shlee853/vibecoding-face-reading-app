...
describe('analyzeFace — 세 가지 경로 (A7)', () => {
  test('ok 경로: 가짜 클라이언트가 유효한 JSON을 반환하면 parsed.kind === "ok"', async () => {
...
describe('analyzeFace — 업스트림 예외 전파', () => {
...
describe('analyzeFace — client.generate 호출 검증', () => {
